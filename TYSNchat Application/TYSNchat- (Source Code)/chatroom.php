...
<body>
                        ...
                        <div style="float: right;">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style="font-size: 15px;">
                                    <a class="dropdown-item" href="chatroom.php"><i class="fa fa-ban"></i> Public Chat</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-4 pr-0 margin-0 d-none d-lg-block">
                <?php 
                    $query = "SELECT * FROM users WHERE id = '".$_SESSION['user_id']."'";
                    $statement = $connect->prepare($query);
                    $statement->execute();
            ...
            <div class="col-lg-8 p-0 margin-0">
                <div class="card" style="height: 94vh;">
                    ...
                    <?php
                        error_reporting(0);
                        if(!$_GET['user']){ ?>
                        <div class="card-header border-0" style="background: #EEEEEE; padding: 15px 0px; text-align: center;">
                            <a href="messages.php" class="float-left ml-3 d-block d-lg-none" style="font-size: 24px; color: black;"><i class="fa fa-arrow-left"></i></a>

                            <h6 class="mt-1" style="font-size: 20px; font-weight: 600;">Public Chat Room</h6>   
                        </div>

                        <div class="card-body" id="user_chat_h_room" style="overflow-x: hidden; overflow-y: scroll;">
                            <div id="room_chat_history"></div>
                        </div>

                        <div class="card-footer" style="background: #EEEEEE; padding-top: 5px;">
                            <div class="row">
                                <div class="col">
                                    <form id="send_message_room">
                                        <div class="input-group mb-1">
                                            
                                            <input type="text" style="border-radius: 30px;" class="form-control pl-3 pr-3 ml-2 mr-2 send_box" id="message_text_room" autocomplete="off" placeholder="Enter Message" />
                                            
                                            <div class="input-group-append">
                                                <button type="submit" class="btn" style="border: none;" id="send_message_room"><img src="images/send.png" style="margin-top: -5px; margin-left: 10px;" width="30px" alt=""></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <?php } else{ ?>
                        <div class="card-header border-0" style="background: #EEEEEE; padding: 10px 20px;">
                            ...
                            <div class="row abcd" id="msg_search_box" style="display: none;">
    ...
    <div style="display: none;" id="hidden2"></div>
    <input type="hidden" name="" id="st_value2">
