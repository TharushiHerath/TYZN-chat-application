                ...
                <div class="main_wrapper">
                    <div class="card">
                        ...
                        <div class="card-footer bg-white border-0 pt-0 pb-0">
                            <button type="button" class="btn btn-sm btn-dark" style="padding: 2px 10px; width: 50%;" id="login">Continue to Chat</button>

                            <div class="row">
                                <div class="col-12 text-center p-1 mt-3">
                                    <p class="already_signed">Not Yet Signed Up? <a href="signup.php" class="text-dark">Signup Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
